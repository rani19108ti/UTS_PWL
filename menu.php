<nav class="navbar navbar-expand-lg bg-secondary rounded-bottom mb-4 text-white">
    <a class="navbar-brand text-monospace text-white" href="index.php">MyApp</a>&emsp;
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item <?= active('home') . empty($_SERVER['QUERY_STRING']) ? 'active' : '' ?> ">
                <a class="nav-link text-white" href="index.php?hal=home">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item <?= active('aboutUs') ?>">
                <a class="nav-link text-white" href="index.php?hal=aboutUs">About Us</a>
            </li>
        ...
        <ul class="navbar-nav my-lg-0">
            ...
            ?>
                <li class="nav-item <?= active('formLogin') ?>">
                    <a class="nav-link text-white" href="index.php?hal=formLogin">Login</a>
                </li>
            <?php } else { ?>
