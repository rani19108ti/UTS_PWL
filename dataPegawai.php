...
<div class="card mb-4">
    <div class="card-header">
        ...
        <div class="d-flex justify-content-between">
            ...
            <?php if (isset($member)) { ?>
                <a href="index.php?hal=formPegawai" class="btn btn-dark">Tambah</a>
            <?php } ?>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <form method="POST" action="controllers/pegawaiController.php">
                                    <a href="index.php?hal=detailPegawai&id=<?= $peg['id']; ?>" class="btn btn-sm btn-dark">Detail</a>
                                    <?php
                                    $role = $member['role'];
                                    if (isset($member)) {
                                    ?>
                                        <a href="index.php?hal=formEditPegawai&id=<?= $peg['id']; ?>" class="btn btn-sm btn-dark">Ubah</a>
                                        <?php if ($role != 'staff') { ?>
